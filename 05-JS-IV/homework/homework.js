...
function crearGato (nombre, edad) { // --"nombre, edad" son los argumentos de esta función--
  ...
  // Tu código:
  const objeto = {
    nombre: nombre, // propiedad "nombre" y se le asigna el valor del argumento de arriba "nombre".
    edad: edad,
    meow: function() {
      return("Meow!")
    }
